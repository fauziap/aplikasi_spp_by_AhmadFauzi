                    ...
                    <tbody class="bg-white divide-y rounded-xl divide-gray-200">
                        @foreach ($datas as $data)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                    <button @click="showModal = true"
                                        wire:click='showUpdate({{$data->id}})'
                                        class="text-blue-500 hover:text-blue-600 mr-2">Edit</button>
                                    <button wire:click='deletee({{$data->id}})' onclick="return confirm('Apakah anda yakin?') || event.stopImmediatePropagation()" class="text-red-500 hover:text-red-600">Hapus</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                                            ...
                                            <form wire:submit.prevent='simpann'>
                                                ...
                                                <div class="mb-4 w-full">
                                                    ...
                                                    <select wire:model='data.kelas' id="level" required
                                                        ...
                                                        <option class="text-gray-700 text-sm font-bold">-- Kelas --</option>
                                                        @foreach ($kelas as $kls)
                                                        <option value="{{$kls->id}}" class="text-gray-700 text-sm font-semibold">
                                                ...
                                                <div class="mb-4 ">
                                                    ...
                                                    <input
                                                        class="shadow border rounded-lg w-[26rem] py-2 px-3 text-gray-700  focus:outline-none focus:shadow-outline"
                                                        id="name" type="email" placeholder="Masukkan username "
                                                ...
                                                <div class="mb-4 ">
                                                    ...
                                                    <input
                                                        ...
                                                        wire:model='data.password' required>
                                                </div>
                                                <div class="mb-4 ">
                                                    <label class="block text-gray-700 text-sm font-bold mb-2"
                                                        for="name">
                                                ...
                                                <div class="mb-4 ">
                                                    ...
                                                    <input
                                                        ...
                                                        wire:model='data.alamat' required>
                                                </div>
                                                <div class="mb-4 ">
                                                    <label class="block text-gray-700 text-sm font-bold mb-2"
                                                        for="name">
                                                    ...
                                                    <input
                                                        class="shadow border rounded-lg w-[26rem] py-2 px-3 text-gray-700  focus:outline-none focus:shadow-outline"
                                                        id="name" type="text" placeholder="Masukkan No Telephone"
                                                ...
                                                <div class="mb-4 w-full">
                                                    ...
                                                    <select wire:model='data.spp' id="level" required
                                                        class="shadow text-gray-700 w-[26rem] text-sm font-bold text-center appearance-none border rounded-lg py-2 px-3 leading-tight focus:outline-none focus:shadow-outline">
                                                        <option class="text-gray-700 text-sm font-bold">-- Spp --</option>
                                                        @foreach ($spp as $spp)
                                                        <option value="{{$spp->id}}" class="text-gray-700 text-sm font-semibold">
                                                            {{$spp->nominal}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="bg-gray-50 -pr-16 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                            ...
                                            <form wire:submit.prevent='updatee'>
                                                ...
                                                <div class="mb-4 ">
                                                    ...
                                                    <input
                                                        class="shadow border rounded-lg w-[26rem] py-2 px-3 text-gray-700  focus:outline-none focus:shadow-outline"
                                                        id="name" type="text"
                                                        placeholder="Masukkan No Telephone" wire:model='data.no_tlp'
                                                        required>
                                                </div>
                                                <div class="mb-4 w-full">
                                                    <label class="block text-gray-700 text-sm font-bold mb-2"
                                                ...
                                                <div
                                                    ...
                                                    <button @click="showModal = false" type="button" wire:click='cancel'
                                                        class="w-full inline-flex -mr-7 justify-center rounded-md  border-gray-300 shadow-sm px-4 py-2 border bg-white text-base font-medium text-gray-700 hover:text-gray-500 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm">
                                                        Cancel
                                                    </button>
                                                    <button type="submit"
