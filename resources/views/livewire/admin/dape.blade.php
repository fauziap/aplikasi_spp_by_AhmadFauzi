                                        ...
                                        <div class="mt-2">
                                            <form wire:submit.prevent='simpann'>
                                                ...
                                                <div class="mb-4 w-full">
                                                    ...
                                                    <select wire:model='data.level' id="level" required
                                                        ...
                                                        <option value="admin" class="text-gray-700 text-sm font-semibold">
                                                            Admin</option>
                                                        <option value="petugas" class="text-gray-700 text-sm font-semibold">
                                                            Petugas</option>
                                                    </select>
                                                </div>
                                            ...
                                            <form wire:submit.prevent='updatee'>
                                                ...
                                                <div class="mb-4 ">
                                                    ...
                                                    <input
                                                        class="shadow border rounded-lg w-[26rem] py-2 px-3 text-gray-700  focus:outline-none focus:shadow-outline"
                                                        id="name" type="email"
                                                        placeholder="Masukkan username " wire:model='data.username' required>
                                                </div>
                                                <div class="mb-4 w-full">
                                                    <label class="block text-gray-700 text-sm font-bold mb-2"
                                                        for="level">
                                                    ...
                                                    <select wire:model='data.level' id="level" required
                                                        class="shadow text-gray-700 w-[26rem] text-sm font-bold text-center appearance-none border rounded-lg py-2 px-3 leading-tight focus:outline-none focus:shadow-outline">
                                                        <option class="text-gray-700 text-sm font-bold">-- Pilih Level --</option>
                                                        <option value="admin"
                                                            class="text-gray-700 text-sm font-semibold">Admin</option>
                                                        <option value="petugas"
                                                            class="text-gray-700 text-sm font-semibold">Petugas</option>
                                                    </select>
                                                </div>
                                                <div
