                        ...
                        @foreach ($datas as $data)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                    ...
                                    <button wire:click='delete({{$data->id}})' onclick="return confirm('Apakah anda yakin?') || event.stopImmediatePropagation();" type="submit" class="text-red-500 hover:text-red-600">Hapus</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                                            ...
                                            <form wire:submit.prevent="simpann">
                                                ...
                                                <div class="mb-4 w-full">
                                                    ...
                                                    <input
                                                        ...
                                                        id="name" type="text" placeholder="Masukkan nominal"
                                                        wire:model='data.nominal' required>
                                                </div>
