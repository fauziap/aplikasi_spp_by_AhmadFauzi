                    ...
                    <tbody class="bg-white divide-y rounded-xl divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                ...
                                <button wire:click='delete({{$data->id}})' onclick="return confirm('Apakah anda yakin?') || event.stopImmediatePropagation();" class="text-red-500 hover:text-red-600">Hapus</button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                                        ...
                                        <div class="mt-2">
                                            <form wire:submit.prevent='simpann'>
                                                ...
                                                <input
                                                    ...
                                                    id="name" type="text" placeholder="Masukkan nama kelas"
                                                    wire:model='data.kelas' required>
                                                </div>
                                                <div class="mb-4 w-full">
                                                    ...
                                                    <input
                                                        ...
                                                        id="name" type="text" placeholder="Masukkan nama jurusan"
